    ...
    <div className="why-container">
      ...
      <div className="why-stats">
        <div className="why-stats-item">
          ...
          <h2>6</h2>
          <small>Machine Tool<br /> Sales Specialists</small>
        </div>
        <div className="why-stats-item">
          <div className="svg-container">
            <DesignIcon />
          ...
          <h2>7</h2>
          <small>Highly Experiences<br /> Technicians</small>
        </div>
        <div className="why-stats-item">
          <div className="svg-container">
            <ClockIcon />
          ...
          <h2>80+</h2>
          <small>Years of Technical<br /> Excellence</small>
        </div>
      </div>

      <div className="why-description">
        <h4>Unmatched Expertise in KZN</h4>
        <p><br /> We bring unmatched expertise and capability to the KwaZulu-Natal region. Our team is skilled across the full spectrum — from conventional machine tools to advanced <span className="red">7-axis and multi-axis CNC systems.</span><br/><br /> Through strategic partnerships with industry leaders, we offer access to some of the best machine tool solutions in the country, covering all sectors. <br /> <br /> This combination of technical expertise, premium partnerships, and cutting-edge product offerings ensures that we deliver reliable, high-performance solutions tailored to your needs.</p>
      </div>
