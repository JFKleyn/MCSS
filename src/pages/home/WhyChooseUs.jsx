      ...
      <FadeIn>
        <div className="why-description">
          ...
          <p>
            ...
            <span className="red">7-axis and multi-axis CNC systems.</span>
            Through strategic partnerships with industry leaders, we offer
            access to some of the best machine tool solutions in the country,
            covering all sectors.This combination of technical expertise,
            premium partnerships, and cutting-edge product offerings ensures
            that we deliver reliable, high-performance solutions tailored to
            your needs.
          </p>
        </div>
      </FadeIn>
