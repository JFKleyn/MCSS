          ...
          <div className="service-page-container-text">
            ...
            <div className="service-page-container-text-text">
              ...
              <p>
                ...
                from our seasoned professionals. We specialize in comprehensive
                training programs covering machine setup, advanced programming,
                and control systems for Siemens, Fanuc, Mitsubishi and GSK
                controllers upon installation
              </p>
            </div>
          ...
          <div className="service-page-container-text">
            ...
            <div className="category-text">
              ...
              <div className="category-text-item">
                <span>•</span>
                <p>
                  Emergency repair services with rapid response times across KZN
                  and nationwide through strategic partnerships
                </p>
              </div>
              <div className="category-text-item">
                <span>•</span>
                <p>
                  Complete diagnostic services using advanced testing equipment
          ...
          <div className="service-page-container-text">
            ...
            <div className="category-text">
              <div className="category-text-item">
                <span>•</span>
                <p>
                  Complete project management from initial consultation through
                  final commissioning and validation
                </p>
              </div>
              <div className="category-text-item">
                <span>•</span>
                <p>
                  Site preparation guidance including foundation specifications,
                  power requirements, and environmental controls
                </p>
              </div>
              <div className="category-text-item">
                <span>•</span>
          ...
          <div className="service-page-container-text">
            ...
            <div className="service-page-container-text-text">
              ...
              <p>
                ...
                delivering custom solutions precisely engineered for your unique
                requirements.
              </p>
            </div>
            <div className="category-text">
              <div className="category-text-item">
                <span>•</span>
                <p>
                  Custom fixturing and tooling design to maximize efficiency and
              ...
              <div className="category-text-item">
                <span>•</span>
                <p>
                  Process optimization consulting to reduce cycle times, improve
              ...
              <div className="category-text-item">
                <span>•</span>
                <p>
                  3D modeling and simulation services to validate designs before
